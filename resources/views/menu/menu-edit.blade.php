                            ...
                            <form method="post" action="{{ route('menu.update',$menu->id) }}" enctype="multipart/form-data">
                               ...
                               @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$menu->nama}}" name="nama" placeholder="Masukkan Nama Menu"
                                        class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Harga Menu</label>
                                    <input type="numeric" value="{{$menu->harga}}" name="harga" placeholder="Masukkan Harga Menu"
                                        class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Deskripsi</label>
                                    <textarea name="desc" class="form-control">{{$menu->desc}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Tipe</label></br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="tipe1" name="tipe"
                                            class="custom-control-input" value="makanan" {{ ($menu->tipe == "makanan") ? "checked" : "" }} required>
                                        <label class="custom-control-label" for="tipe1">Makanan</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="tipe2" name="tipe"
                                            class="custom-control-input" value="minuman" {{ ($menu->tipe == "minuman") ? "checked" : "" }} required>
